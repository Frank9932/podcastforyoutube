...
def main():
    ...
    parser.add_argument("--show_name", type=str, required=True, help="podcast show name")
    parser.add_argument("--data_dir", type=str, required=True, help="local data dir of the podcast")
    parser.add_argument("--web_dir", type=str, required=True, help="web dir of the podcast")
